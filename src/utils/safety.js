...
export const abusePatterns = [
  ...
  /\b(slut|whore|bitch|bastard|idiot|stupid)\b/i,
  /\b(nude|send pic|send photo|hookup|sex chat)\b/i,
  /\b(address|phone number|whatsapp|instagram|snapchat|telegram|gmail)\b/i
];
...
export function detectAbuse(text = '') {
  ...
  return matched ? { blocked: true, reason: 'This message may hurt someone or request personal contact. Please rewrite it gently.' } : { blocked: false };
}
